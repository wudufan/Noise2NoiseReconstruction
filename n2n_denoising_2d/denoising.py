...
#                               '--vmax', '1.15',
                              '--checkPoint', 
                              '../../train/recon/n2n_denoising_2d/pretrain/beta_0_gaussian',
                              '--model', 'encoder_decoder',
                              '--outDir', '../../train/recon/n2n_denoising_2d/test'])
else:
    showPlots = False
...
refs = x / args.imgNorm
imgs1 = np.load(args.src+'_0.npy')[args.slices[0]:args.slices[1],...] / args.imgNorm
imgs2 = np.load(args.src+'_1.npy')[args.slices[0]:args.slices[1],...] / args.imgNorm
...
testingNet.imgshape = [refs.shape[1], refs.shape[2], 1]
