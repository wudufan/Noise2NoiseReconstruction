...
parser.add_argument('--gamma', dest='gamma', type=float, default = 2.5e-4)
...
if sys.argv[0] != 'recon_admm_fp.py':
...
#                               '--vmax', '1.15',
                              '--checkPoint', 
                              '../../train/recon/n2n_fp/pretrain/beta_0_filter_2_dose_0.125',
                              '--model', 'encoder_decoder',
                              '--outDir', '../../train/recon/n2n_fp/admm/test'])
else:
    showPlots = False
